...
(sio-class "consensus" "consensus is an acceptable resolution, one that can be supported, even if not the preferred outcome for each individual."
           :super agreement)
(sio-class "full agreement" "full agreement is the result of consensus decision making when members of the group unanimously agree."
           :super agreement)
...
(as-disjoint-subclasses
 curvature
 (sio-class "straight" "straight is a quality of a bearer that is free of curves, bends, or angles."
            :annotation
...
(as-subclasses
 ...
 (sio-class "user account" "user account allows a user to authenticate to system services and be granted authorization to access them."))
...
(as-subclasses
 line_segment
 (sio-class "directed line segment" "A directed line segment is a line segment that is contained by an ordered pair of endpoints (a start point and an endpoint)."
...
(sio-class "axis" "An axis is a line segment that is part of a statistical graph in which the position along the line corresponds to a numeric or categorical value."
...
(as-disjoint-subclasses
 axis
 (sio-class "category axis" "A category axis is an axis in which the position along the line is partioned into categories."
            :annotation
            (eg "The horizontal axis corresponding to months of the year in graph 4 of http://tinyurl.com/opwnvm"))
 (sio-class "value axis" "A value axis is an axis in which the position along the line is partioned into numeric values."
            :annotation
...
(as-disjoint-subclasses
 ...
 (sio-class "secondary category axis" "A secondary category axis is a category axis that defines a finer granular part (or subset) of the value range of the primary category axis."
            :annotation
...
(as-subclasses
 ...
 (sio-class "y-axis" "A y-axis is a Cartesian coordinate axis that is spatially oriented perpendicular to the x-axis."
            :annotation
            (synonym-rdf "vertical axis"))
 (sio-class "z-axis" "A z-axis is a Cartesian coordinate axis that is spatially oriented normal to the plane formed by the x- and y-axes."))
...
(as-subclasses
 terminal_point
 (sio-class "start point" "A start point is a terminal point which is the first of an ordered pair of points.")
 ...
 (sio-class "endpoint" "An endpoint is a terminal point that is the last of an ordered pair of points."))
...
(sio-class "primary graph title" "A primary graph title is a primary title that describes a statistical graph."
...
(as-subclasses
 bar_graph
 (sio-class "horizontal bar graph" "A horizontal bar graph is a bar graph in which the rectangular bars are horizontally oriented in space."
            :annotation
            (eg "Graph 3 in http://tinyurl.com/opwnvm"))
 (sio-class "stacked bar graph" "A stacked bar graph is a bar graph in which each rectangular bar is partioned by the categorical value of each series of data."
            :annotation
            (eg "Graphs 6,7 in http://tinyurl.com/opwnvm"))
 (sio-class "vertical bar graph" "A vertical bar graph is a bar graph in which the rectangular bars are vertically oriented in space."
            :annotation
...
(as-subclasses
 ...
 (sio-class "beta strand" "a beta strand is structural region of a protein that is characterized by a roughly planar sequence of amino acid residues forming hydrogen bonds between the N-O and the C=O  of another part of the peptide and having their side chains perpendicular to the planar axis."))
